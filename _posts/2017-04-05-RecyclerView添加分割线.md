...
博客封装得不错，比自己写的半吊子要好，所以直接拿来使用并封装在了开发框架内。
**使用方法**
提供了三个构造函数，使用者可以使用默认的或者自定义样式。
```
...
**万能分割线类**
非常通用的类，可以根据自定项目中的需求修改样式。
不过这个源码是有个坑的，就是构造函数里面的this(context, orientation);使用的时候一定要注释或者删除。否则都是默认的效果！
```
...
原文来自：http://blog.csdn.net/pengkv/article/details/50538121
**向开源者致敬！**
